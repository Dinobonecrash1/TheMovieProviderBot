...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5817124748').split()]
...
URL = "https://{142.93.209.247:8082}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://{142.93.209.247:8082}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://{142.93.209.247:8082}/".format(FQDN)
else:
    URL = "https://{142.93.209.247:8082}/".format(FQDN)

# add premium logs channel id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001586987735'))
